package bonclub.office_private.web_gui.user_area.panel_header;
...
public class PanelHeader extends Panel{
	...
	private void onBonCard(){
		this.executer.action(UserArea.eventBonCard, null);
	}
	private void onNakopilka(){
		this.executer.action(UserArea.eventNakopilka, null);
	}
