...
public class Xml extends Interface<File>
{
	...
	public Xml(String myInterfaceId, Properties myProps, SMSServer myServer, InterfaceTypes interfaceTypes)
	{
		super(myInterfaceId, myProps, myServer, interfaceTypes);
