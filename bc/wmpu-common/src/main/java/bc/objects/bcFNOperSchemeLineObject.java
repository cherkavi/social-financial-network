...
public class bcFNOperSchemeLineObject extends bcObject {
	private final static Logger LOGGER=Logger.getLogger(bcFNOperSchemeLineObject.class);
	private Map<String,Comparable<String>> fieldHm = new HashMap<String, Comparable<String>>();
	
	private String idOperSchemeLine;
	
	public bcFNOperSchemeLineObject(String pIdOperSchemeLine) {
		this.idOperSchemeLine = pIdOperSchemeLine;
		getFeature();
	}
	
	private void getFeature() {
		String featureSelect = " SELECT * FROM " + getGeneralDBScheme() + ".VC_FN_OPER_SCHEME_LINES_ALL WHERE id_fn_oper_scheme_line = ?";
    ...
    public String getClubRelationshipsHTML(String p_beg, String p_end) {
        ...
        String mySQL = 
	        " SELECT rn, id_club_rel, date_club_rel, name_club_rel_type,  " +
	       	...
	       	"                  WHERE id_bk_operation_scheme_line = " + this.idOperSchemeLine +
	      	"         ) WHERE ROWNUM < " + p_end +
	      	" ) WHERE rn >= " + p_beg;
