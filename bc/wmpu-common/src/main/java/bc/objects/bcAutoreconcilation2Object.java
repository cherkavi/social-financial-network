...
public class bcAutoreconcilation2Object extends bcObject {
	private Map<String,Comparable<String>> fieldHm = new HashMap<String, Comparable<String>>();
	private final static Logger LOGGER=Logger.getLogger(bcAutoreconcilation2Object.class);
	
	private String idAutoreconcil;
	
	public bcAutoreconcilation2Object() {	}
	
	public bcAutoreconcilation2Object(String pIdAutoreconcil) {
