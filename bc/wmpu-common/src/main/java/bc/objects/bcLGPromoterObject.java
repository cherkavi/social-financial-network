...
public class bcLGPromoterObject extends bcObject {
	private final static Logger LOGGER=Logger.getLogger(bcLGPromoterObject.class);
	private Map<String,Comparable<String>> fieldHm = new HashMap<String, Comparable<String>>();
	
	private String idLGPromoter;
	
	public bcLGPromoterObject(String pIdLGPromoter) {
    ...
    public String getSchedulePreviewHTML(String pFindString, String promoterState, String p_beg, String p_end) {
        ...
        if (!isEmpty(promoterState)) {
           	mySQL = mySQL + " AND cd_lg_promoter_give_state = '" + promoterState + "' ";
        }
    ...
    public String getPaymentParamHistoryHTML(String pFindString, String p_beg, String p_end) {
        ...
        if ("CASHIER".equalsIgnoreCase(lPromoterPos) ||
	        ...
	        mySQL = 
	        	...
	        	"        cashier_pay_oc_salary_frmt, cashier_first_card_np_frmt, " +
	            ...
	            "                cashier_first_card_not_pay cashier_first_card_np_frmt, " +
	        	"                id_lg_promoter_pay_param "+
	            "           FROM (SELECT * " +
