...
public class bcEmailMessageReceiverObject extends bcObject {
	private final static Logger LOGGER=Logger.getLogger(bcEmailMessageReceiverObject.class);
	
	private Map<String,Comparable<String>> fieldHm = new HashMap<String, Comparable<String>>();
	
	private String idMessageReceiver;
	
	public bcEmailMessageReceiverObject(String pIdMessageReceiver) {
	...
	public String getMessageSendHTML(String pFindString, String pState, String p_beg, String p_end) {
        ...
        try{
            ...
            while (rset.next())
            {
                ...
                String myHyperLink = "../crm/dispatch/messages/email_messagesendspecs.jsp?entry_type=RECEIVER&id_message_receiver="+this.idMessageReceiver+"&id="+rset.getString("ID_DS_MESSAGE_SEND");
