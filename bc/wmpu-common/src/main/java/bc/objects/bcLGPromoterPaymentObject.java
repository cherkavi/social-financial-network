...
public class bcLGPromoterPaymentObject extends bcObject {
	private final static Logger LOGGER=Logger.getLogger(bcLGPromoterPaymentObject.class);
	
	private Map<String,Comparable<String>> fieldHm = new HashMap<String, Comparable<String>>();
	
	private String idLGPromoterPayment;
	
	public bcLGPromoterPaymentObject(String pIdLGPromoterPayment) {
