...
/** проверка на Equals указанного значения и значения из хранилища */
public class ConditionParameterEquals extends ActionStepCondition{
	/**
	 */
	...
	/** Сравнить параметр в Промежуточном хранилище и int значение
	 * @param parameter_name имя значения из промежуточного хранилища 
	 * @param parameter сравниваемое значение  
	 */
	public ConditionParameterEquals(String parameter_name,int parameter){
	...
	/** Сравнить параметр в Промежуточном хранилище и String значение
	 * @param parameter_name имя значения из промежуточного хранилища 
	 * @param parameter сравниваемое значение  
	 */
	public ConditionParameterEquals(String parameter_name, String parameter){
		this.field_parameter_name=parameter_name;
		this.field_parameter=parameter;
		this.field_flag_parameter_type=TYPE_STRING;
	}

	/** Сравнить параметр в Промежуточном хранилище и byte[] значение
	 * @param parameter_name имя значения из промежуточного хранилища 
	 * @param parameter сравниваемое значение  
	 */
	public ConditionParameterEquals(String parameter_name,byte[] parameter){
		this.field_parameter_name=parameter_name;
		this.field_parameter=parameter;
