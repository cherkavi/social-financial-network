...
/** проверка на Equals двух значений из Промежуточного хранилища */
public class ConditionParameterAndParameterEquals extends ActionStepCondition{
	/**
	 */
	...
	/** 
	 * Проверка на Equals двух переменных из Промежуточного хранилища
	 ...
	 *  <i>Integer(int)</i><br>
	 * */
	public ConditionParameterAndParameterEquals(String parameter_name_source,String parameter_name_destination, int type){
