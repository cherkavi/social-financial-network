...
public class CalculatorHeadOfByteArray extends ActionStepCalculator{
	private final static Logger LOGGER=Logger.getLogger(CalculatorHeadOfByteArray.class);
	 ...
	 */
	public CalculatorHeadOfByteArray(String param_source, String param_destination, int count){
