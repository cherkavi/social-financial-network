var page = 1;
	...
	function showFirstPage(){
		document.getElementById("arr_beg").src = "images/arr_beg2.gif";
		document.getElementById("arr_left").src = "images/arr_left2.gif";
	...
	function showNotFirstPage(){
		document.getElementById("arr_beg").src = "images/arr_beg.gif";
		document.getElementById("arr_left").src = "images/arr_left.gif";
