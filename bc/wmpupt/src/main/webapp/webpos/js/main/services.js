	...
	function setParam(language, sessionId, contextPath, rowsPerPage) {
		lang = language;
		sess = sessionId;
		cont = contextPath;
		rows = rowsPerPage;
	...
	function send_request_to_server2() {
		send_request_to_server(func, par2, par3);
	}
	...
	function showFirstPage(){
		document.getElementById("arr_beg").src = cont + "/images/arr_beg2.gif";
		document.getElementById("arr_left").src = cont + "/images/arr_left2.gif";
	...
	function showNotFirstPage(){
		document.getElementById("arr_beg").src = cont + "/images/arr_beg.gif";
		document.getElementById("arr_left").src = cont + "/images/arr_left.gif";
