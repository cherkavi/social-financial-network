...
<table width="100%" class="tablesorter" id="id_table">
	<thead>
	<tr>
		<th><%= Bean.oper_schemeXML.getfieldTransl("ID_BK_OPERATION_SCHEME_LINE", false)%></th>
		<th><%= Bean.oper_schemeXML.getfieldTransl("NAME_CLUB_REL_TYPE", false)%></th>
		<th><%= Bean.oper_schemeXML.getfieldTransl("NAME_BK_OPERATION_TYPE", false)%></th>
		<th><%= Bean.oper_schemeXML.getfieldTransl("NAME_BK_PHASE", false)%></th>
		<th><%= Bean.oper_schemeXML.getfieldTransl("OPER_NUMBER", false)%></th>
		<th><%= Bean.oper_schemeXML.getfieldTransl("DEBET_CD_BK_ACCOUNT", false)%></th>
		<th><%= Bean.oper_schemeXML.getfieldTransl("CREDIT_CD_BK_ACCOUNT", false)%></th>
		<th><%= Bean.oper_schemeXML.getfieldTransl("OPER_CONTENT", false)%></th>
	</tr>
	</thead>
	<tbody id="rows">
