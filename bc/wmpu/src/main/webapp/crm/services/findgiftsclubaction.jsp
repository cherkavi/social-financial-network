...
String id_realization = Bean.getDecodeParamPrepare(parameters.get("id_realization"));
...
<table width="100%" class="tablesorter" id="id_table">
	...
	<tr>
		...
		<th><%= Bean.club_actionXML.getfieldTransl("BAL_COUNT", false)%></th>
		<th><%= Bean.club_actionXML.getfieldTransl("CD_CURRENCY", false)%></th>
	</tr>
	</thead>
	<tbody id="rows">
