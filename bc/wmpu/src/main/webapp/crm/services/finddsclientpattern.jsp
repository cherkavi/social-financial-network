...
String pageFormName = "FIND_DS_CLIENT_PATTERN";
...
String id_cl_pattern = Bean.getDecodeParamPrepare(parameters.get("id_cl_pattern"));
String name_cl_pattern = Bean.isEmpty(id_cl_pattern)?"":id_cl_pattern;
...
<body onload="focusInput(); checkExpr(); send_request(); return false;">
	...
	<%=Bean.getServiceFindTable(name_cl_pattern) %>
